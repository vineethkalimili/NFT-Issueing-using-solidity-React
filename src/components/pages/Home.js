      ...
      <MDBRow>
        ...
        <MDBCol col='4' md='6'>
          ...
          <div className="text-BLACK">
              <h4 class="mb-4">Welcome to the code economy</h4>
              <p class="small mb-0">Our lives – and work – are getting a software upgrade. 
          ...
          <MDBBtn className="mb-4 w-100" size="lg" href='/Tokens'
            >ADMIN</MDBBtn>
          <MDBBtn className="mb-4 w-100" size="lg">USER</MDBBtn>
